export default {
  ...
  'header.Yapay Zeka BirimiTemplate': '默认角色模板',
  'header.searchHistory': '搜索历史',
  'header.clearHistory': '清空历史',
  'header.Hizmet SağlayıcıManagement': '字段管理',
  ...
  'firmwareDialog.uploadHint': '温馨提示：请上传合并前的VoiaX.bin文件，而不是合并后的merged-binary.bin文件',
  ...
  // 上下文源对话框相关
  'contextHizmet SağlayıcıDialog.title': '编辑源',
  'contextHizmet SağlayıcıDialog.noContextApi': '暂无上下文API',
  'contextHizmet SağlayıcıDialog.add': '添加',
  'contextHizmet SağlayıcıDialog.apiUrl': '接口地址',
  'contextHizmet SağlayıcıDialog.apiUrlPlaceholder': 'http://api.example.com/data',
  'contextHizmet SağlayıcıDialog.requestHeaders': '请求头',
  'contextHizmet SağlayıcıDialog.headerKeyPlaceholder': 'Key',
  'contextHizmet SağlayıcıDialog.headerValuePlaceholder': 'Value',
  'contextHizmet SağlayıcıDialog.noHeaders': '暂无 Headers',
  'contextHizmet SağlayıcıDialog.addHeader': '添加 Header',
  'contextHizmet SağlayıcıDialog.cancel': '取消',
  'contextHizmet SağlayıcıDialog.confirm': '确定',

  // 角色配置页面-上下文源相关
  'roleConfig.contextHizmet Sağlayıcı': '上下文源',
  'roleConfig.contextHizmet SağlayıcıSuccess': '已成功添加 {count} 个源。',
  'roleConfig.contextHizmet SağlayıcıDocLink': '如何部署上下文源',
  'roleConfig.editContextHizmet Sağlayıcı': '编辑源',
  ...
  // 字段管理页面文本
  'Hizmet SağlayıcıManagement.categoryFilter': '类别筛选',
  'Hizmet SağlayıcıManagement.searchPlaceholder': '请输入供应器名称查询',
  'Hizmet SağlayıcıManagement.category': '类别',
  'Hizmet SağlayıcıManagement.Hizmet SağlayıcıCode': '供应器编码',
  'Hizmet SağlayıcıManagement.fieldConfig': '字段配置',
  'Hizmet SağlayıcıManagement.selectToDelete': '请先选择需要删除的供应器',
  'Hizmet SağlayıcıManagement.confirmDelete': '确定要删除选中的{count}个供应器吗？',
  'Hizmet SağlayıcıManagement.viewFields': '查看字段',
  ...
  'common.addHizmet Sağlayıcı': '新增供应器',
  'common.success': '成功',
  'common.editHizmet Sağlayıcı': '编辑供应器',
  ...
  // 首页文本
  'home.addYapay Zeka Birimi': '添加智能体',
  'home.greeting': '你好VoiaX',
  ...
  'home.confirmDeleteYapay Zeka Birimi': '确定要删除该智能体吗？',
  ...
  'paramManagement.updateSuccess': '修改成功，部分配置需重启VoiaX-server模块才生效',
  'paramManagement.addSuccess': '新增成功',
  'paramManagement.updateFailed': '更新失败',
  'paramManagement.addFailed': '新增失败',

  // 服务端管理页面文本
  'serverSideKontrol Merkezi.pageTitle': '服务端管理',
  'serverSideKontrol Merkezi.wsAddress': 'ws地址',
  'serverSideKontrol Merkezi.operation': '操作',
  'serverSideKontrol Merkezi.restart': '重启',
  'serverSideKontrol Merkezi.updateConfig': '更新配置',
  'serverSideKontrol Merkezi.restartServer': '重启服务端',
  'serverSideKontrol Merkezi.updateConfigTitle': '更新配置',
  'serverSideKontrol Merkezi.confirmRestart': '确定要重启服务端吗？',
  'serverSideKontrol Merkezi.confirmUpdateConfig': '确定要更新配置吗？',
  'serverSideKontrol Merkezi.loading': '拼命加载中',
  'serverSideKontrol Merkezi.getServerListFailed': '获取服务端列表失败',
  'serverSideKontrol Merkezi.operationFailed': '操作失败',
  'serverSideKontrol Merkezi.restartSuccess': '重启成功',
  'serverSideKontrol Merkezi.updateConfigSuccess': '更新配置成功',

  // 添加智能体对话框文本
  'addYapay Zeka BirimiDialog.title': '添加智能体',
  'addYapay Zeka BirimiDialog.Yapay Zeka BirimiName': '智能体名称',
  'addYapay Zeka BirimiDialog.placeholder': '请输入智能体名称..',
  'addYapay Zeka BirimiDialog.confirm': '确定',
  'addYapay Zeka BirimiDialog.cancel': '取消',
  'addYapay Zeka BirimiDialog.nameRequired': '请输入智能体名称',
  'addYapay Zeka BirimiDialog.addSuccess': '添加成功',
  ...
  'roleConfig.reset': '重置',
  'roleConfig.Yapay Zeka BirimiName': '助手昵称',
  ...
  'modelConfig.Hizmet Sağlayıcı': '接口类型',
  ...
  'modelConfig.setDefaultSuccess': '设置默认模型成功，请及时手动重启VoiaX-server模块',
  ...
  // 字段管理页面模型类型翻译
  'Hizmet SağlayıcıManagement.all': '全部',
  'Hizmet SağlayıcıManagement.modelType.ASR': '语音识别',
  'Hizmet SağlayıcıManagement.modelType.TTS': '语音合成',
  'Hizmet SağlayıcıManagement.modelType.LLM': '大语言模型',
  'Hizmet SağlayıcıManagement.modelType.VLLM': '视觉大语言模型',
  'Hizmet SağlayıcıManagement.modelType.Intent': '意图识别',
  'Hizmet SağlayıcıManagement.modelType.Memory': '记忆模块',
  'Hizmet SağlayıcıManagement.modelType.VAD': '语音活动检测',
  'Hizmet SağlayıcıManagement.modelType.Plugin': '插件工具',
  'Hizmet SağlayıcıManagement.modelType.RAG': '知识库',

  // Hizmet Sağlayıcı Dialog 翻译
  'Hizmet SağlayıcıDialog.category': '类别',
  'Hizmet SağlayıcıDialog.selectCategory': '请选择类别',
  'Hizmet SağlayıcıDialog.code': '编码',
  'Hizmet SağlayıcıDialog.inputCode': '请输入供应器编码',
  'Hizmet SağlayıcıDialog.name': '名称',
  'Hizmet SağlayıcıDialog.inputName': '请输入供应器名称',
  'Hizmet SağlayıcıDialog.sort': '排序',
  'Hizmet SağlayıcıDialog.fieldConfig': '字段配置',
  'Hizmet SağlayıcıDialog.add': '添加',
  'Hizmet SağlayıcıDialog.deselectAll': '取消全选',
  'Hizmet SağlayıcıDialog.selectAll': '全选',
  'Hizmet SağlayıcıDialog.batchDelete': '批量删除',
  'Hizmet SağlayıcıDialog.fieldKey': '字段key',
  'Hizmet SağlayıcıDialog.fieldLabel': '字段标签',
  'Hizmet SağlayıcıDialog.fieldType': '字段类型',
  'Hizmet SağlayıcıDialog.type': '类型',
  'Hizmet SağlayıcıDialog.stringType': '字符串',
  'Hizmet SağlayıcıDialog.numberType': '数字',
  'Hizmet SağlayıcıDialog.booleanType': '布尔值',
  'Hizmet SağlayıcıDialog.dictType': '字典',
  'Hizmet SağlayıcıDialog.arrayType': '分号分割的列表',
  'Hizmet SağlayıcıDialog.ragType': '知识库',
  'Hizmet SağlayıcıDialog.defaultValue': '默认值',
  'Hizmet SağlayıcıDialog.inputDefaultValue': '请输入默认值',
  'Hizmet SağlayıcıDialog.operation': '操作',
  'Hizmet SağlayıcıDialog.edit': '编辑',
  'Hizmet SağlayıcıDialog.complete': '完成',
  'Hizmet SağlayıcıDialog.delete': '删除',
  'Hizmet SağlayıcıDialog.save': '保存',
  'Hizmet SağlayıcıDialog.requiredCategory': '请选择类别',
  'Hizmet SağlayıcıDialog.requiredCode': '请输入供应器编码',
  'Hizmet SağlayıcıDialog.requiredName': '请输入供应器名称',
  'Hizmet SağlayıcıDialog.completeFieldEdit': '请先完成当前字段的编辑',
  'Hizmet SağlayıcıDialog.confirmDeleteField': '确定要删除该字段吗？',
  'Hizmet SağlayıcıDialog.selectFieldsToDelete': '请先选择要删除的字段',
  'Hizmet SağlayıcıDialog.confirmBatchDeleteFields': '确定要删除选中的{count}个字段吗？',
  'Hizmet SağlayıcıDialog.batchDeleteFieldsSuccess': '成功删除{count}个字段',

  // 默认角色模版页面文本
  'Yapay Zeka BirimiTemplateManagement.title': '默认角色管理',
  'Yapay Zeka BirimiTemplateManagement.templateName': '模板名称',
  'Yapay Zeka BirimiTemplateManagement.action': '操作',
  'Yapay Zeka BirimiTemplateManagement.createTemplate': '创建模板',
  'Yapay Zeka BirimiTemplateManagement.editTemplate': '编辑模板',
  'Yapay Zeka BirimiTemplateManagement.deleteTemplate': '删除模板',
  'Yapay Zeka BirimiTemplateManagement.deleteSuccess': '模板删除成功',
  'Yapay Zeka BirimiTemplateManagement.batchDelete': '批量删除',
  'Yapay Zeka BirimiTemplateManagement.batchDeleteSuccess': '批量删除成功',
  'Yapay Zeka BirimiTemplateManagement.selectTemplate': '请选择模板',
  'Yapay Zeka BirimiTemplateManagement.select': '选择',
  'Yapay Zeka BirimiTemplateManagement.searchPlaceholder': '请输入模板名称搜索',
  'Yapay Zeka BirimiTemplateManagement.search': '搜索',
  'Yapay Zeka BirimiTemplateManagement.serialNumber': '序号',
  'Yapay Zeka BirimiTemplateManagement.selectAll': '全选',
  'Yapay Zeka BirimiTemplateManagement.deselectAll': '取消全选',
  'Yapay Zeka BirimiTemplateManagement.loading': '拼命加载中',
  'Yapay Zeka BirimiTemplateManagement.confirmSingleDelete': '确定要删除这个模板吗？',
  'Yapay Zeka BirimiTemplateManagement.confirmBatchDelete': '确定要删除选中的 {count} 个模板吗？',
  'Yapay Zeka BirimiTemplateManagement.deleteFailed': '模板删除失败',
  'Yapay Zeka BirimiTemplateManagement.batchDeleteFailed': '模板批量删除失败',
  'Yapay Zeka BirimiTemplateManagement.deleteBackendError': '删除失败，请检查后端服务是否正常',

  // 模板快速配置页面文本
  'templateQuickConfig.title': '模块快速配置',
  'templateQuickConfig.Yapay Zeka BirimiSettings.Yapay Zeka BirimiName': '助手昵称',
  'templateQuickConfig.Yapay Zeka BirimiSettings.Yapay Zeka BirimiNamePlaceholder': '请输入助手昵称',
  'templateQuickConfig.Yapay Zeka BirimiSettings.systemPrompt': '角色介绍',
  'templateQuickConfig.Yapay Zeka BirimiSettings.systemPromptPlaceholder': '请输入角色介绍',
