export default {
  ...
  // HeaderBar组件文本
  'header.smartManagement': 'Yapay Zeka Birimis',
  ...
  'header.Yapay Zeka BirimiTemplate': 'Varsayılan Rol Şablonları', // 添加这一行
  'header.searchHistory': 'Search History',
  'header.clearHistory': 'Clear History',
  'header.Hizmet SağlayıcıManagement': 'Hizmet Sağlayıcı Management',
  ...
  'firmwareDialog.uploadHint': 'Warm reminder: Please upload the pre-merged VoiaX.bin file, not the merged merged-binary.bin file',
  ...
  // Context Hizmet Sağlayıcı dialog related
  'contextHizmet SağlayıcıDialog.title': 'Edit Source',
  'contextHizmet SağlayıcıDialog.noContextApi': 'No Context API',
  'contextHizmet SağlayıcıDialog.add': 'Add',
  'contextHizmet SağlayıcıDialog.apiUrl': 'API URL',
  'contextHizmet SağlayıcıDialog.apiUrlPlaceholder': 'http://api.example.com/data',
  'contextHizmet SağlayıcıDialog.requestHeaders': 'Request Headers',
  'contextHizmet SağlayıcıDialog.headerKeyPlaceholder': 'Key',
  'contextHizmet SağlayıcıDialog.headerValuePlaceholder': 'Value',
  'contextHizmet SağlayıcıDialog.noHeaders': 'No Headers',
  'contextHizmet SağlayıcıDialog.addHeader': 'Add Header',
  'contextHizmet SağlayıcıDialog.cancel': 'Cancel',
  'contextHizmet SağlayıcıDialog.confirm': 'Confirm',

  // Role config page - context Hizmet Sağlayıcı related
  'roleConfig.contextHizmet Sağlayıcı': 'Context',
  'roleConfig.contextHizmet SağlayıcıSuccess': 'Successfully added {count} sources.',
  'roleConfig.contextHizmet SağlayıcıDocLink': 'How to deploy context Hizmet Sağlayıcı',
  'roleConfig.editContextHizmet Sağlayıcı': 'Edit Source',
  ...
  'register.welcome': 'Welcome to VoiaX AI',
  ...
  // Hizmet Sağlayıcı Management Page Text
  'Hizmet SağlayıcıManagement.categoryFilter': 'Category Filter',
  'Hizmet SağlayıcıManagement.searchPlaceholder': 'Please enter Hizmet Sağlayıcı name to search',
  'Hizmet SağlayıcıManagement.category': 'Category',
  'Hizmet SağlayıcıManagement.Hizmet SağlayıcıCode': 'Hizmet Sağlayıcı Code',
  'Hizmet SağlayıcıManagement.fieldConfig': 'Field Configuration',
  'Hizmet SağlayıcıManagement.selectToDelete': 'Please select Hizmet Sağlayıcıs to delete first',
  'Hizmet SağlayıcıManagement.confirmDelete': 'Are you sure to delete the selected {count} Hizmet Sağlayıcıs?',
  'Hizmet SağlayıcıManagement.viewFields': 'View Fields',
  ...
  'common.addHizmet Sağlayıcı': 'Add Hizmet Sağlayıcı',
  'common.success': 'Success',
  'common.editHizmet Sağlayıcı': 'Edit Hizmet Sağlayıcı',
  ...
  'home.confirmDeleteYapay Zeka Birimi': 'Are you sure you want to delete this Yapay Zeka Birimi?',
  ...
  'paramManagement.updateSuccess': 'Update successful. Some configurations will take effect only after restarting the VoiaX-server module.',
  ...
  'serverSideKontrol Merkezi.pageTitle': 'Server Management',
  'serverSideKontrol Merkezi.wsAddress': 'WS Address',
  'serverSideKontrol Merkezi.operation': 'Operation',
  'serverSideKontrol Merkezi.restart': 'Restart',
  'serverSideKontrol Merkezi.updateConfig': 'Update Config',
  'serverSideKontrol Merkezi.restartServer': 'Restart Server',
  'serverSideKontrol Merkezi.updateConfigTitle': 'Update Config',
  'serverSideKontrol Merkezi.confirmRestart': 'Are you sure you want to restart the server?',
  'serverSideKontrol Merkezi.confirmUpdateConfig': 'Are you sure you want to update the config?',
  'serverSideKontrol Merkezi.loading': 'Loading...',
  'serverSideKontrol Merkezi.getServerListFailed': 'Failed to get server list',
  'serverSideKontrol Merkezi.operationFailed': 'Operation failed',
  'serverSideKontrol Merkezi.restartSuccess': 'Restart successful',
  'serverSideKontrol Merkezi.updateConfigSuccess': 'Config update successful',

  // Add Yapay Zeka Birimi dialog text
  'addYapay Zeka BirimiDialog.title': 'Add Yapay Zeka Birimi',
  'addYapay Zeka BirimiDialog.Yapay Zeka BirimiName': 'Yapay Zeka Birimi Name',
  'addYapay Zeka BirimiDialog.placeholder': 'Please enter Yapay Zeka Birimi name..',
  'addYapay Zeka BirimiDialog.confirm': 'Confirm',
  'addYapay Zeka BirimiDialog.cancel': 'Cancel',
  'addYapay Zeka BirimiDialog.nameRequired': 'Please enter Yapay Zeka Birimi name',
  'addYapay Zeka BirimiDialog.addSuccess': 'Add successful',
  ...
  'roleConfig.Yapay Zeka BirimiName': 'Nickname',
  ...
  'functionDialog.mcpAddressDesc': 'Below are the MCP access point addresses for the Yapay Zeka Birimi.',
  ...
  'modelConfig.Hizmet Sağlayıcı': 'Interface Type',
  ...
  'modelConfig.setDefaultSuccess': 'Set default model successful, please restart the VoiaX-server module manually in time',
  ...
  // Hizmet Sağlayıcı Management page model type translations
  'Hizmet SağlayıcıManagement.all': 'All',
  'Hizmet SağlayıcıManagement.modelType.ASR': 'Speech Recognition',
  'Hizmet SağlayıcıManagement.modelType.TTS': 'Text-to-Speech',
  'Hizmet SağlayıcıManagement.modelType.LLM': 'Large Language Model',
  'Hizmet SağlayıcıManagement.modelType.VLLM': 'Vision Large Language Model',
  'Hizmet SağlayıcıManagement.modelType.Intent': 'Intent Recognition',
  'Hizmet SağlayıcıManagement.modelType.Memory': 'Memory Module',
  'Hizmet SağlayıcıManagement.modelType.VAD': 'Voice Activity Detection',
  'Hizmet SağlayıcıManagement.modelType.Plugin': 'Plugin Tool',
  'Hizmet SağlayıcıManagement.modelType.RAG': 'RAG',

  // Hizmet Sağlayıcı Dialog translations
  'Hizmet SağlayıcıDialog.category': 'Category',
  'Hizmet SağlayıcıDialog.selectCategory': 'Please select category',
  'Hizmet SağlayıcıDialog.code': 'Code',
  'Hizmet SağlayıcıDialog.inputCode': 'Please input Hizmet Sağlayıcı code',
  'Hizmet SağlayıcıDialog.name': 'Name',
  'Hizmet SağlayıcıDialog.inputName': 'Please input Hizmet Sağlayıcı name',
  'Hizmet SağlayıcıDialog.sort': 'Sort',
  'Hizmet SağlayıcıDialog.fieldConfig': 'Field Configuration',
  'Hizmet SağlayıcıDialog.add': 'Add',
  'Hizmet SağlayıcıDialog.deselectAll': 'Deselect All',
  'Hizmet SağlayıcıDialog.selectAll': 'Select All',
  'Hizmet SağlayıcıDialog.batchDelete': 'Batch Delete',
  'Hizmet SağlayıcıDialog.fieldKey': 'Field Key',
  'Hizmet SağlayıcıDialog.fieldLabel': 'Field Label',
  'Hizmet SağlayıcıDialog.fieldType': 'Field Type',
  'Hizmet SağlayıcıDialog.type': 'Type',
  'Hizmet SağlayıcıDialog.stringType': 'String',
  'Hizmet SağlayıcıDialog.numberType': 'Number',
  'Hizmet SağlayıcıDialog.booleanType': 'Boolean',
  'Hizmet SağlayıcıDialog.dictType': 'Dictionary',
  'Hizmet SağlayıcıDialog.arrayType': 'Semicolon-separated List',
  'Hizmet SağlayıcıDialog.ragType': 'RAG',
  'Hizmet SağlayıcıDialog.defaultValue': 'Default Value',
  'Hizmet SağlayıcıDialog.inputDefaultValue': 'Please input default value',
  'Hizmet SağlayıcıDialog.operation': 'Operation',
  'Hizmet SağlayıcıDialog.edit': 'Edit',
  'Hizmet SağlayıcıDialog.complete': 'Complete',
  'Hizmet SağlayıcıDialog.delete': 'Delete',
  'Hizmet SağlayıcıDialog.save': 'Save',
  'Hizmet SağlayıcıDialog.requiredCategory': 'Please select category',
  'Hizmet SağlayıcıDialog.requiredCode': 'Please input Hizmet Sağlayıcı code',
  'Hizmet SağlayıcıDialog.requiredName': 'Please input Hizmet Sağlayıcı name',
  'Hizmet SağlayıcıDialog.completeFieldEdit': 'Please complete current field editing first',
  'Hizmet SağlayıcıDialog.confirmDeleteField': 'Are you sure to delete this field?',
  'Hizmet SağlayıcıDialog.selectFieldsToDelete': 'Please select fields to delete first',
  'Hizmet SağlayıcıDialog.confirmBatchDeleteFields': 'Are you sure to delete {count} selected fields?',
  'Hizmet SağlayıcıDialog.batchDeleteFieldsSuccess': 'Successfully deleted {count} fields',

  // Yapay Zeka BirimiTemplateManagement
  'Yapay Zeka BirimiTemplateManagement.title': 'Default Role Management',
  'Yapay Zeka BirimiTemplateManagement.templateName': 'Template Name',
  'Yapay Zeka BirimiTemplateManagement.action': 'Action',
  'Yapay Zeka BirimiTemplateManagement.createTemplate': 'Create Template',
  'Yapay Zeka BirimiTemplateManagement.editTemplate': 'Edit Template',
  'Yapay Zeka BirimiTemplateManagement.deleteTemplate': 'Delete Template',
  'Yapay Zeka BirimiTemplateManagement.deleteSuccess': 'Template deleted successfully',
  'Yapay Zeka BirimiTemplateManagement.batchDelete': 'Batch Delete',
  'Yapay Zeka BirimiTemplateManagement.batchDeleteSuccess': 'Batch deletion successful',
  'Yapay Zeka BirimiTemplateManagement.selectTemplate': 'Please select a template',
  'Yapay Zeka BirimiTemplateManagement.select': 'Select',
  'Yapay Zeka BirimiTemplateManagement.searchPlaceholder': 'Please enter template name to search',
  'Yapay Zeka BirimiTemplateManagement.search': 'Search',
  'Yapay Zeka BirimiTemplateManagement.serialNumber': 'Serial Number',
  'Yapay Zeka BirimiTemplateManagement.selectAll': 'Select All',
  'Yapay Zeka BirimiTemplateManagement.deselectAll': 'Deselect All',
  'Yapay Zeka BirimiTemplateManagement.loading': 'Loading...',
  'Yapay Zeka BirimiTemplateManagement.confirmSingleDelete': 'Are you sure you want to delete this template?',
  'Yapay Zeka BirimiTemplateManagement.confirmBatchDelete': 'Are you sure you want to delete the selected {count} templates?',
  'Yapay Zeka BirimiTemplateManagement.deleteFailed': 'Template deletion failed',
  'Yapay Zeka BirimiTemplateManagement.batchDeleteFailed': 'Template batch deletion failed',
  'Yapay Zeka BirimiTemplateManagement.deleteBackendError': 'Deletion failed, please check if the backend service is normal',

  // templateQuickConfig
  'templateQuickConfig.title': 'Module Quick Configuration',
  'templateQuickConfig.Yapay Zeka BirimiSettings.Yapay Zeka BirimiName': 'Nickname',
  'templateQuickConfig.Yapay Zeka BirimiSettings.Yapay Zeka BirimiNamePlaceholder': 'Please enter nickname',
  'templateQuickConfig.Yapay Zeka BirimiSettings.systemPrompt': 'Introduction',
  'templateQuickConfig.Yapay Zeka BirimiSettings.systemPromptPlaceholder': 'Please enter ntroduction',
  ...
  // Bilgi Dağarcığı Management page text
  'knowledgeBaseManagement.title': 'Bilgi Dağarcığı',
  'knowledgeBaseManagement.searchPlaceholder': 'Please enter Bilgi Dağarcığı name to search',
  'knowledgeBaseManagement.search': 'Search',
  'knowledgeBaseManagement.name': 'Bilgi Dağarcığı Name',
  'knowledgeBaseManagement.description': 'Bilgi Dağarcığı Description',
  ...
  'knowledgeBaseManagement.addKnowledgeBase': 'Add Bilgi Dağarcığı',
  'knowledgeBaseManagement.editKnowledgeBase': 'Edit Bilgi Dağarcığı',
  'knowledgeBaseManagement.getKnowledgeBaseListFailed': 'Failed to get Bilgi Dağarcığı list',
  'knowledgeBaseManagement.selectKnowledgeBaseFirst': 'Please select Bilgi Dağarcığıs to delete first',
  'knowledgeBaseManagement.confirmBatchDelete': 'Are you sure you want to delete the selected {count} Bilgi Dağarcığıs?',
  'knowledgeBaseManagement.batchDeleteSuccess': 'Successfully deleted {count} Bilgi Dağarcığıs',
  ...
  // Bilgi Dağarcığı Dialog text
  'knowledgeBaseDialog.title': 'Bilgi Dağarcığı',
  'knowledgeBaseDialog.name': 'Bilgi Dağarcığı Name',
  'knowledgeBaseDialog.namePlaceholder': 'Please enter Bilgi Dağarcığı name accurately to improve the accuracy of Bilgi Dağarcığı call',
  'knowledgeBaseDialog.description': 'Bilgi Dağarcığı Description',
  'knowledgeBaseDialog.descriptionPlaceholder': 'Please enter Bilgi Dağarcığı description accurately to help the model better understand the Bilgi Dağarcığı content',
  ...
  'knowledgeBaseDialog.requiredName': 'Please enter Bilgi Dağarcığı name',
  'knowledgeBaseDialog.nameRequired': 'Please enter Bilgi Dağarcığı name',
  'knowledgeBaseDialog.nameLength': 'Bilgi Dağarcığı name length should be between 1 and 50 characters',
  'knowledgeBaseDialog.namePattern': 'Bilgi Dağarcığı name can only contain Chinese, English, numbers, spaces, underscores and hyphens',
  'knowledgeBaseDialog.descriptionLength': 'Bilgi Dağarcığı description cannot exceed 200 characters',
  'knowledgeBaseDialog.nameLengthLimit': 'Bilgi Dağarcığı name cannot exceed 50 characters',
  'knowledgeBaseDialog.descriptionLengthLimit': 'Bilgi Dağarcığı description cannot exceed 200 characters',

  // Bilgi Dağarcığı Management page new view button text
  ...
  'knowledgeFileUpload.knowledgeBaseName': 'Bilgi Dağarcığı Name',
  ...
  'knowledgeBaseDialog.descriptionRequired': 'Please enter Bilgi Dağarcığı description',
  ...
  'featureManagement.group.voiceManagement': 'Visible to users during Yapay Zeka Birimi configuration',
  ...
  'feature.voiceClone.description': 'Clone specific voice Ses Tınısı using AI technology to achieve personalized voice synthesis',
  'feature.knowledgeBase.name': 'Bilgi Dağarcığı',
  'feature.knowledgeBase.description': 'Build and manage Bilgi Dağarcığı system to provide professional knowledge support for AI assistants',
