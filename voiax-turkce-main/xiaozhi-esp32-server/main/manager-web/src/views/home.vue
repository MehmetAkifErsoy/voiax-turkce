      ...
      <div>
        ...
        <div class="add-device">
          <div class="add-device-bg">
            <div class="hellow-text" style="margin-top: 30px; font-size: 28px; line-height: 1.4;">
              VoiaX Kontrol Merkezi'ne Hoş Geldiniz
            </div>
            <div class="hellow-text" style="font-size: 22px; line-height: 1.4;">
              Sistem Durumu Optimizasyonu ve Görev Yönetimi
            </div>
            <div class="hi-hint" style="font-size: 14px; opacity: 0.85;">
              Tüm operasyonel birimler çevrimiçi ve yönetime hazır.
            </div>
